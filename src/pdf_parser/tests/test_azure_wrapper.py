...
def test_document_split_one_page(mock_azure_client, one_page_mock_analyse_result,
                                 mock_document_download_response_one_page):
...
def test_document_split_two_page(
    mock_azure_client,
    one_page_mock_analyse_result,
    mock_document_download_response_two_page
):
